<<html>
    ...
    <div class="titulo">
        <img  src="imagenes/imagen1.png"width="300px" height="200px" />
        <div class="titulo-texto">Indecora</div>
        <div class="titulo-texto1">UNA SOLUCION PARA TODOS</div> 
        <img class= img src="imagenes/imagen2.png" width="150px"height="100"/>
    </div>
        <br>
        <br>
        <br>
    ...
    <br>
    <br>
    <div class="pagina4">Cuadros</div>
    <div class="pagina1">1 2 3 4 </div>
    <br>
    <br>
    <br>
    <br>
    <br>
    <br>
    <div class="pagina2">Inicio > Cuadros  </div>
    
    <div id="contenedor_principal">
        <!--Primera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen67.jpg" width="300px" height="300px"></div>
            <div class="texto">CUADRO ALAS</div>
            <div class="texto1">Cuadro con alas doradas <br>y base color gris <br>de 45,7 x 45,7 ,.</div>
            <div class="texto2">Precio $ 1,100.00</div>
        </div>

        <!--Segunda Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen59.jpg" width="300px" height="300px"></div>
            <div class="texto">CUADRO ROSTROS</div>
            <div class="texto1">Set 2 cuadros rostros damas con <br>Sonmbresos florales </div><br>
            <div class="texto2">Precio $ 1,100.00   </div>
        </div>

        <!--tercera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen60.png" width="300px" height="300px"></div>
            <div class="texto">CUADROS DIENTE DE LEON </div>
            <div class="texto1">Set 2 cuadros a blabco y negro<br>de 55,7 x 55,7 cm ,<br>marco negor</div>
            <div class="texto2">Precio $ 950.00</div>
        </div>
    <br>
    <br>
    <br>
    <br>
        <!--cuarta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen61.jpg" width="300px" height="300px"></div>
            <div class="texto">SET DE CUADROS HOJAS</div>
            <div class="texto1">Cuadros hojas dollar<br>de 55,7 x 55,7 cm <br></div>
            <div class="texto2">Precio $ 1,300.00</div>
        </div>
    
        <!--quinta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen62.jpg" width="300px" height="300px"></div>
            <div class="texto">CUADROS FLORES DORADAS</div>
            <div class="texto1">Set de cuadros elegantes<br>de 45,7 x 45,7 cm para sofá,<br>marcos color blanco.</div>
            <div class="texto2">Precio $ 1,900.00</div>
        </div>
    
        <!--sexta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen63.jpg" width="300px" height="300px"></div>
            <div class="texto">CUADRO ABTRACTO</div>
            <div class="texto1">Cuadro decoracion dorada en el centro<br> de 45,7 x 45,7 cm <br>terminado con hoja de oro.</div>
            <div class="texto2">Precio $ 1,450.00</div>
        </div>
    <br>
    <br>
    <br>
    <br>
        <!--septima Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen64.jpg" width="300px" height="300px"></div>
            <div class="texto">CUADROS DECORATIVOS</div>
            <div class="texto1">Cuadro con hojas, de 45,7 x 45,7<br>tres diferentes diseños en tonos<br>dorado y beige con tonos gris.</div>
            <div class="texto2">Precio $ 2,990.00</div>
        </div>
        
        <!--octava Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen65.jpg" width="300px" height="300px"></div>
            <div class="texto">CUADRO PLUMAS</div>
            <div class="texto1">Trio de plumas 130 x 50 cm<br>marco de madera blanca<br>en tonalidades neutras.</div>
            <div class="texto2">Precio $ 1,370.00</div>
        </div>
    
        <!--novena Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen66.jpg" width="300px" height="300px"></div>
            <div class="texto">CUADRO ALAS DE ANGEL</div>
            <div class="texto1">DISEÑO MARMOL 130 x 90 cm<br>marco de madera dorado<br>en tonalidades neutras.</div>
            <div class="texto2">Precio $ 1,470.00</div>
        </div> 
    </div>       
    <br>
    <br>
    ...
    <div class="barra">
        <p>
            <br>
           Nombre: Karina Guadalupe Barragán Jara<br>Codigo: 304180712 
           <br>Nombre Materia: Conceptualización de servicios en la nube
           <br>Correo:<a href="mailto:kbarragan725@gmail.com">kbarragan725@gmail.com</a>
            <br>
            <br>
        </p>
    </div>   
