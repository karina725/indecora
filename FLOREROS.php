<html>
    ...
    <br>
    <br>
    <div class="pagina4">Floreros</div>
    ...
    <br>
    <br>
    <div class="pagina2">Inicio > Floreros  </div>
    
    <div id="contenedor_principal">
        <!--Primera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen32.jpg" width="300px" height="300px"></div>
            <div class="texto">FLORESOS YIN YANG</div>
            <div class="texto1">Set de jarronnes alargados <br>30cm alto, diametro de 15.<br>Negor y blanco</div>
            <div class="texto2">Precio $ 490.00</div>
        </div>

        <!--Segunda Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen33.jpg" width="300px" height="300px"></div>
            <div class="texto"> <br>SET JARRONES</div>
            <div class="texto1">Tres jarrones, 25cm,30cm,35cm<br>alto,base blanca con dorado.</div><br>
            <div class="texto2">Precio $ 530.00</div>
        </div>

        <!--tercera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen34.jpg" width="300px" height="300px"></div>
            <div class="texto">FLORERO DE CRISTAL GOLD</div>
            <div class="texto1">Florero alto 35cm, diametro 45.<br>borde decorado de hojas de laurel<br></div><br>
    ...
    <br>
        <!--cuarta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen35.jpg" width="300px" height="300px"></div>
            <div class="texto">FLORERO PLATA</div>
            <div class="texto1">altura 35 cm, decorativo <br><br></div><br>
            <div class="texto2">Precio $ 200.00</div>
        </div>
    
        <!--quinta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen36.jpg" width="300px" height="300px"></div>
            <div class="texto"><br>SET FLOREROS CRISTAL</div>
            <div class="texto1">3 floreros material de cristal<br>con toques de brillo color gold. <br></div><br>
            <div class="texto2">Precio $ 800.00</div>
        </div>
    
        <!--sexta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen37.jpg" width="300px" height="300px"></div>
            <div class="texto">FLORERO GOLD</div>
            <div class="texto1">Acabado dorado, formas diamants <br>35cm de alto.<br></div><br>
    ...
    <br>
        <!--septima Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen38.jpg" width="300px" height="300px"></div>
            <div class="texto"><br>FLOREROS DIAMETE NEGRO </div>
            <div class="texto1">30cm alto, diametro de 15.<br>Negor con bases dordas.</div><br>
            <div class="texto2">Precio $ 375.00</div>
        </div>
        
        <!--octava Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen39.jpg" width="300px" height="300px"></div>
            <div class="texto">FLOREROS CRISTAL NEGRO</div>
            <div class="texto1">2 floresos negros, con la boca dorada <br>altura de 40cm.<br></div><br>
            <div class="texto2">Precio $ 295.00</div>
        </div>
    
        <!--novena Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen40.png" width="300px" height="300px"></div>
            <div class="texto">FLOREROS ASIMETRICOS</div>
            <div class="texto1">Set de 4 floredos asimetrisco <br>color negro con acabado <br>mate, diseños diferentes.</div>
