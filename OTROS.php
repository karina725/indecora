<html>
    ...
    <br>
    <br>
    <div class="pagina2">Inicio > Otros  </div>
    
    <div id="contenedor_principal">
        <!--Primera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen86.jpg" width="300px" height="300px"></div>
            <div class="texto">CUADROS CON LETRERO LOVE</div>
            <div class="texto1">Juego de 3 cojines decorativas<br>de 45,7 x 45,7 cm para sofá,<br>recámara, sofá, etc.</div>
            <div class="texto2">Precio $ 650</div>
        </div>

        <!--Segunda Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen87.webp" width="300px" height="300px"></div>
            <div class="texto">RELOJ</div>
            <div class="texto1">Cojín decorativo de 30 x 50 cm<br>para sofá, recámara, sofá, etc</div><br>
            <div class="texto2">Precio $ 350</div>
        </div>

        <!--tercera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen88.jpg" width="300px" height="300px"></div>
            <div class="texto">SET DE ALMACENAMIENTO </div>
            <div class="texto1">Cojín decorativo, varios colores<br>de 45,7 x 45,7 cm para sofá,<br>recámara, sofá, etc</div>
            <div class="texto2">Precio $ 450</div>
        </div>
    <br>
    <br>
    <br>
    <br>
        <!--cuarta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen89.jpg" width="300px" height="300px"></div>
            <div class="texto">REPISA DE MADERA</div>
            <div class="texto1">Cojín decorativo de 45,7 x 45,7<br>cm para sofá, recámara, sofá, etc<br></div>
            <div class="texto2">Precio $ 200</div>
        </div>
    
        <!--quinta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen90.jpg" width="300px" height="300px"></div>
            <div class="texto">ESTANTERA NEGRA</div>
            <div class="texto1">Juego de 4 cojines decorativas<br>de 45,7 x 45,7 cm para sofá,<br>recámara, sofá, etc.</div>
            <div class="texto2">Precio $ 800</div>
        </div>
    
        <!--sexta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen91.jpg" width="300px" height="300px"></div>
            <div class="texto">LETRERO HOME</div>
    ...
    <br>
        <!--septima Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen92.jpg" width="300px" height="300px"></div>
            <div class="texto">REPISA PARA COCINA</div>
            <div class="texto1">Cojín decorativo de 45,7 x 45,7<br>cm para sofá, terciopelo, varios<br>colores recámara, sofá, etc</div>
            <div class="texto2">Precio $ 299</div>
        </div>
        
        <!--octava Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen93.jpg" width="300px" height="300px"></div>
            <div class="texto">LETRERO HOME SWEET HOME </div>
            <div class="texto1">Juego de 3 cojines decorativas<br>de 45,7 x 45,7 cm para sofá,<br>recámara, sofá, etc.</div>
            <div class="texto2">Precio $ 590</div>
        </div>
    
        <!--novena Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen94.jpg" width="300px" height="300px"></div>
            <div class="texto">MARCOS CON LETRERO HOME</div>
            <div class="texto1">Cojín decorativo de 30 x 50 cm<br>para sofá, recámara, sofá, etc.<br>Diferentes diseños</div>
            <div class="texto2">Precio $ 370</div>
        </div> 
    </div>       
    <br>
    <br>
