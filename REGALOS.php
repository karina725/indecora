<html>
    ...
    <br>
    <br>
    <div class="pagina2">Inicio > Regalos  </div>
    
    <div id="contenedor_principal">
        <!--Primera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen77.jpg" width="300px" height="300px"></div>
            <div class="texto">CAMARA INSTANTANEA</div>
        ...
        <!--Segunda Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen78.png" width="300px" height="300px"></div>
            <div class="texto">LAMPARAS EN FORMA DE CORAZON / ESTRELLA</div>
        ...
        <!--tercera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen79.jpg" width="300px" height="300px"></div>
            <div class="texto">LAMPARA DE LUNA</div>
    ...
    <br>
        <!--cuarta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen80.jpg" width="300px" height="300px"></div>
            <div class="texto">PUFF ACOGEDOR</div>
        ...
        <!--quinta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen81.jpg" width="300px" height="300px"></div>
            <div class="texto">TABURETE FELPUDO</div>
        ...
        <!--sexta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen82.jpg" width="300px" height="300px"></div>
            <div class="texto">LAMPARA DE DIAMANTE</div>
    ...
    <br>
        <!--septima Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen83.jpg" width="300px" height="300px"></div>
            <div class="texto">ALAJERO</div>
        ...
        <!--octava Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen84.jpg" width="300px" height="300px"></div>
            <div class="texto">ESPEJO CON FOCOS</div>
            <div class="texto1">Juego de 3 cojines decorativas<br>de 45,7 x 45,7 cm para sofá,<br>recámara, sofá, etc.</div>
        ...
        <!--novena Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen85.jpg" width="300px" height="300px"></div>
            <div class="texto">RELOR NUBE</div>
