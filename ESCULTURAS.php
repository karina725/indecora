<html>
    ...
    <br>
    <br>
    <div class="pagina">Esculturas</div>
    ...
    <br>
    <br>
    <div class="pagina2">Inicio > Esculturas  </div>
    
    <div id="contenedor_principal">
        <!--Primera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen68.jpg" width="300px" height="300px"></div>
            <div class="texto">PENSANTES</div>
            <div class="texto1">Juego de 3 esculturas decorativas<br>de 45,7 x 45,7 cm ,<br>ideal para decorar tu sala.</div>
            <div class="texto2">Precio $ 950.00</div>
        </div>

        <!--Segunda Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen69.jpg" width="300px" height="300px"></div>
            <div class="texto">BUDA</div>
            <div class="texto1">Escultura de buda <br>material de acero</div><br>
            <div class="texto2">Precio $ 650.00</div>
        </div>

        <!--tercera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen70.jpg" width="300px" height="300px"></div>
            <div class="texto">DUO DE MANZANAS</div>
            <div class="texto1">Manzanas decorativas <br>colores plata y dorado <br>material de aluminio</div>
    ...
    <br>
        <!--cuarta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen71.jpg" width="300px" height="300px"></div>
            <div class="texto">ROSTRO</div>
            <div class="texto1">Buesto de mujer <br>con una pareja de enamorados <br>entrelazandos</div>
            <div class="texto2">Precio $ 900.00</div>
        </div>
    
        <!--quinta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen72.jpg" width="300px" height="300px"></div>
            <div class="texto">PERRITO</div>
            <div class="texto1">Llavero en forma de <br>perrito, con tonos blancoy dorado<br>altura de 50cm</div>
            <div class="texto2">Precio $ 800.00</div>
        </div>
    
        <!--sexta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen73.jpg" width="300px" height="300px"></div>
            <div class="texto">BUSTO DE NIÑA CON MARIPOSA</div>
            <div class="texto1">Hemoso busto de niña <br>con mariposa en tonalidad blanca<br>y dorada, con un toque de rosa.</div>
            <div class="texto2">Precio $ 750.00</div>
        </div>
    <br>
    <br>
    ...
    <br>
        <!--septima Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen74.jpg" width="300px" height="300px"></div>
            <div class="texto">ESCULTURA ABSTRACTA</div>
            <div class="texto1">Cojín decorativo de 45,7 x 45,7<br>cm para sofá, terciopelo, varios<br>colores recámara, sofá, etc</div>
            <div class="texto2">Precio $ 999.00</div>
        </div>
        
        <!--octava Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen75.jpg" width="300px" height="300px"></div>
            <div class="texto">PAREJA DE CONEJOS</div>
            <div class="texto1">Pareja de conejos<br>de 45,7 x 45,7 cm ,<br>en tonalidades blancas.</div>
            <div class="texto2">Precio $ 990.00</div>
        </div>
    
        <!--novena Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen76.jpg" width="300px" height="300px"></div>
            <div class="texto">PLUMAS</div>
            <div class="texto1">Juego de plimas ideal para<br>separador de libros.<br>Tamaño 45cm</div>
            <div class="texto2">Precio $ 870.00</div>
        </div> 
    </div>       
    <br>
    <br>
