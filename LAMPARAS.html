<html>
    ...
    <br>
    <br>
    <div class="pagina2">Inicio > Lamparas  </div>
    
    <div id="contenedor_principal">
        <!--Primera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen41.jpg" width="300px" height="300px"></div>
            <div class="texto">Lamparas de mesa</div>
            <div class="texto1">Set 2 lamparas mesa de noche<br>base plata, con pantalla<br>blanca altura de 60cm.</div>
            <div class="texto2">Precio $ 2,500.00</div>
        </div>

        <!--Segunda Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen42.jpg" width="300px" height="300px"></div>
            <div class="texto"><br/>Set lamparas </div>
            <div class="texto1">2 lamparas mesa de noche altura de 60cm,<br>1 lampara de piso. bases de madera negra<br>alturas de 1.20cm </div><br>
            <div class="texto2">Precio $ 3,900.00</div>
        </div>

        <!--tercera Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen43.jpg" width="300px" height="300px"></div>
            <div class="texto">Lampara de piso</div>
            <div class="texto1">Base de madera color negro<br>pantalla color blanco<br>altura de 90cm.</div>
            <div class="texto2">Precio $ 790.00</div>
        </div>
    <br>
    <br>
    <br>
    <br>
        <!--cuarta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen44.jpg" width="300px" height="300px"></div>
            <div class="texto">Lampara arco</div>
            <div class="texto1">Material resistente<br>altura de 90cm<br></div><br/>
            <div class="texto2">Precio $ 750.00</div>
        </div>
    
        <!--quinta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen45.jpg" width="300px" height="300px"></div>
            <div class="texto">Lampara de mesa</div>
            <div class="texto1">Base de madera caoba<br>altura 55cm,<br>pantalla de yute.</div>
            <div class="texto2">Precio $ 485.00</div>
        </div>
    
        <!--sexta Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen46.jpg" width="300px" height="300px"></div>
            <div class="texto">Lampara artesanal </div>
            <div class="texto1">Base de cristal templado<br>bocolor<br>pantalla color beige.</div>
            <div class="texto2">Precio $ 450.00</div>
        </div>
    <br>
    <br>
    <br>
    <br>
        <!--septima Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen47.jpg" width="300px" height="300px"></div>
            <div class="texto">Lampara plata</div>
            <div class="texto1">Acabado brillante color plata<br>altura de 60cm.<br>Ideal para dormitorio.</div>
            <div class="texto2">Precio $ 299.00</div>
        </div>
        
        <!--octava Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen48.jpg" width="300px" height="300px"></div>
            <div class="texto">Lampara asimetrica</div>
            <div class="texto1">Lampara de acero color dorado<br>con base asimetrica,<br>altura de 60cm.</div>
            <div class="texto2">Precio $ 590.00</div>
        </div>
    
        <!--novena Imagen-->
        <div class="contenedor_imagen_texto">
            <div class="imagen"><img src="imagenes/imagen49.jpg" width="300px" height="300px"></div>
            <div class="texto">Lampara base exagonos</div>
            <div class="texto1">Lampara con base en metal color dorado<br>Pantalla color negro.<br>Altura 60cm.</div>
            <div class="texto2">Precio $ 490.00</div>
        </div> 
    </div>       
    <br>
    <br>
